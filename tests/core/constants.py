    ...
    SRScript( # [13]
        ...
        blocks=[
            SRBlock(
                ...
                inputs={
                    "INDEX": SREmbeddedBlockInputValue(
                        block=SRBlock(
                    ...
                    "ITEM": SREmbeddedBlockInputValue(
                        block=SRBlock(
                    ...
                    "KEEP": SRBlockAndBoolInputValue(
                        block=SRBlock(
                            opcode="&operators::(VALUE) as a boolean",
                            inputs={
                                "VALUE": SRBlockAndTextInputValue(
                                    block=SRBlock(
                                        opcode="&lists::{{FILTER INDEX}}",
                                        inputs={},
                                        dropdowns={},
...
ALL_SR_BLOCKS = [
    ...
    *ALL_SR_SCRIPTS[13].blocks,
     ALL_SR_SCRIPTS[13].blocks[0].inputs["INDEX"].block,
     ALL_SR_SCRIPTS[13].blocks[0].inputs["ITEM"].block,
     ALL_SR_SCRIPTS[13].blocks[0].inputs["KEEP"].block,
     ALL_SR_SCRIPTS[13].blocks[0].inputs["KEEP"].block.inputs["VALUE"].block,
]
