from pmp_manip.utility import AbstractTreePath, GU_InvalidValueError
...
def test_SRExtension_validate():
    ...
    execute_attr_validation_tests(
        obj=extension,
        attr_tests=[
            ("id", "some-invalid-id", GU_InvalidValueError),
        ],
...
def test_SRCustomExtension_validate_url():
    ...
    execute_attr_validation_tests(
        obj=extension,
        attr_tests=[
            ("url", "x://a.b.c", GU_InvalidValueError),
        ],
...
def test_SRCustomExtension_validate_js_uri():
    ...
    execute_attr_validation_tests(
        obj=extension,
        attr_tests=[
            ("url", "x:a/b,Lorem%20ipsum%20dolor%20sit%20amet%2C%20consetetur%20sadipscing%20elitr%2C%20sed%20diam", GU_InvalidValueError),
        ],
        validate_func=SRCustomExtension.validate,
        func_args=[AbstractTreePath()]
    )
