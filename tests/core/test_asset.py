...
def test_SRVectorCostume_create_empty():
...
def test_SRVectorCostume_validate():
    ...
    execute_attr_validation_tests(
        obj=srcostume,
        attr_tests=[
            ("name", 5, MANIP_TypeValidationError),
            ("file_extension", {}, MANIP_TypeValidationError),
            ("file_extension", "jpg", MANIP_InvalidValueError),
            ("rotation_center", [], MANIP_TypeValidationError),
...
def test_SRBitmapCostume_eq_equal(bitmap_example):
    a = SRBitmapCostume(
        name="my costume",
        file_extension="png",
        rotation_center=(0, 0),
...
def test_SRBitmapCostume_eq_super(bitmap_example):
    a = SRBitmapCostume(
...
def test_SRBitmapCostume_eq_different_has_double_resolution(bitmap_example):
    a = SRBitmapCostume(
        name="my costume",
        file_extension="png",
        rotation_center=(0, 0),
...
def test_SRBitmapCostume_eq_different_content():
    a = SRBitmapCostume(
        name="my costume",
        file_extension="png",
        rotation_center=(0, 0),
...
def test_SRBitmapCostume_validate(bitmap_example):
    ...
    execute_attr_validation_tests(
        ...
        attr_tests=[
            ...
            ("file_extension", {}, MANIP_TypeValidationError),
            ("rotation_center", [], MANIP_TypeValidationError),
            ("content", b"\x89PNG", MANIP_TypeValidationError),
...
def test_SRSound_validate(sound_example):
    srsound = SRSound(
        name="Hello there!",
        file_extension="wav",
