...
from pmp_manip.utility          import lists_equal_ignore_order, assert_lists_equal_ignore_order, string_to_sha256, MANIP_ConversionError, GU_ValidationError
...
def test_ValidationIF_get_cb_mutation_invalid_custom_opcode(validation_if: ValidationIF):
    validation_if_copy = deepcopy(validation_if)
    with raises(GU_ValidationError):
