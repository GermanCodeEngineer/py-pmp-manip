...
from pmp_manip.otility.decorators import enforce_type, _repr_type, AbstractTreePath
from pmp_manip.otility.errors import MANIPO_PathValidationError, MANIPO_TypeValidationError, MANIPO_RangeValidationError, MANIPO_InvalidValueError
...
def _passes(fn: Callable[..., Any], *args, **kwargs) -> bool:
    try:
        fn(*args, **kwargs)
        return True
    except MANIPO_PathValidationError:
        return False
...
class ValidateAttribute:
    ...
    VA_TYPE = Validator(
        ...
        error_cls=MANIPO_TypeValidationError,
    ...
    VA_EQUAL = Validator(
        ...
        error_cls=MANIPO_InvalidValueError,
