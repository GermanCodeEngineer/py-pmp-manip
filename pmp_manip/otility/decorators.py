...
def enforce_type(value: Any, expected: Any, path: AbstractTreePath | None = None, condition: str | None = None, notset_as_special: bool = True) -> None:
    ...
    Raises MANIPO_TypeValidationError on mismatch.
    ...
    Raises:
        MANIPO_TypeValidationError: If the value does not match the expected type
    """
    ...
    if _is_union(expected):
        ...
        for arm in arms:
            try:
                ...
                return
            except MANIPO_TypeValidationError:
                continue
        raise MANIPO_TypeValidationError(
            path,
